...
- R has a rich environment for statistical computing and graphics.
- If you get proficient, you can easily create beautiful and interactive graphics!
...
regdata <- read_csv(here::here("data/2024-04-Registration-Cohort(Form1).csv"), locale=locale(encoding="latin1"),
         ...
         skip = 1) |> 
  mutate(aff2 = fct_lump(affiliation, 4)) |> 
  mutate(n = n(), .by = aff2) |> 
