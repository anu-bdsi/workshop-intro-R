...
The workshop aims to get participants started with using R for basic computations. The workshop is suitable for those who have no prior knowledge of R or those who wish to have a refresher in R. It is assumed that the participants know basic statistical summaries (e.g., mean, median, standard deviation, etc).
