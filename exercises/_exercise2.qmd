...
- What is the total number of cases (`case = 1`) in infertility after spontaneous _and_ induced abortion in the `infert` data? `r fitb(sum(infert$case[infert$induced > 0 & infert$spontaneous]))`
